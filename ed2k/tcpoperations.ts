import { OP_HELLO, PS_NEW, PS_WAITING_DATA, PS_CRYPT_NEGOTIATING, PS_READY, PR_ED2K, PR_ZLIB, PR_EMULE, OP_LOGINREQUEST, OP_OFFERFILES, OP_GETSERVERLIST, OP_GETSOURCES_OBFU, OP_GETSOURCES, OP_SEARCHREQUEST, OP_CALLBACKREQUEST, ENODE_VERSIONSTR, ENODE_NAME, CS_ENCRYPTING, TYPE_UINT8, OP_FOUNDSOURCES, TYPE_HASH, TYPE_UINT32, TYPE_UINT16, OP_SEARCHRESULT, OP_SERVERLIST, OP_SERVERSTATUS, OP_IDCHANGE, OP_CALLBACKFAILED, OP_SERVERIDENT, TYPE_TAGS, TYPE_STRING, TAG_SERVER_NAME, TAG_SERVER_DESC, OP_SERVERMESSAGE, OP_CALLBACKREQUESTED } from "./op";
...
var receive = {
  ...
  loginRequest: function(client) {
    ...
    var data: Buffer = client.packet.data
